...
public class Robot extends TimedRobot {
	...
	*/
    ...
    public void robotInit() {
        ...
        chooser.addOption("Just Goose It", new DriveOverObstacle());
        ...
        chooser.addOption("Rampart", new DriveOverObstacle(DriveOverObstacle.Obstacle.RAMPART));
        chooser.addOption("Moat", new DriveOverObstacle(DriveOverObstacle.Obstacle.MOAT));
        chooser.addOption("Wall", new DriveOverObstacle(DriveOverObstacle.Obstacle.WALL));
        chooser.addOption("Terrain", new DriveOverObstacle(DriveOverObstacle.Obstacle.TERRAIN));
